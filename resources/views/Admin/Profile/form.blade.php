...
<h5 class="font-20 mt-15 mb-1">@if($user->id<0) Save  @else Update @endif Profile</h5>
{{ Form::model($user, array('url' => 'profile_update/'.$user->id, 'method' => 'patch', 'class' => 'form-horizontal','files'=>'true')) }}
...
<div class="form-group">
	<div class="col-sm-offset-4 col-sm-8">
		<button type="submit" class="btn btn-success"> @if (empty($user->id)) Save @else Update @endif</button>
	</div>
</div>
{{ Form::close() }}
<script>
